                    ...
                    <div class="mt-3">
                      ...
                      <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog">
                          <form class="modal-content" method="POST" action="{{ route('promo.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="modal-header">
                              <h5 class="modal-title" id="backDropModalTitle">Tambah Promo</h5>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="name2Backdrop" class="form-label">Harga Sebelum Diskon</label>
                                  <input
                                    type="number"
                                    id="nameBackdrop"
                                    class="form-control"
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="name3Backdrop" class="form-label">Harga Setelah Diskon</label>
                                  <input
                                    type="number"
                                    id="name3Backdrop"
                                    class="form-control"
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                  <label for="name4Backdrop" class="form-label">Berlaku sampai</label>
                                  <input
                                    type="date"
                                    id="name4Backdrop"
                                    class="form-control"
                      ...
                      <div class="modal fade" id="modalScrollable{{ $item->id }}" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="modalScrollableTitle">Hapus Promo</h5>
                              <button
                                type="button"
                                class="btn-close"
                                data-bs-dismiss="modal"
                            ...
                            <form action="{{ route('promo.destroy', ['promo' => $item->id]) }}" method="POST">
                              @method('DELETE')
                              @csrf
                            <div class="modal-body">
                              <p>
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                        ...
                        <td>{{ $item->nama }}</td>
                        <td>{{ $item->kategori }}</td>
                        <td>{{ $item->harga_before }}</td>
                        <td>{{ $item->harga_after }}</td>
                        ...
                        <td>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{ route('promo.show', ['promo' => $item->id]) }}"
