  ...
  @endif
    ...
    <div class="col-xl">
      <div class="card mb-4">
        ...
        <div class="card-body">
          <form action="{{ route('menu.edit', ['menu' => $menu->id]) }}" method="POST" enctype="multipart/form-data">
            @method('PATCH')  
            @csrf

            <div class="mb-3">
              <label class="form-label" for="basic-default-fullname">Nama</label>
              <input type="text" class="form-control" id="basic-default-fullname" name="nama" value="{{ $menu->nama }}" />
            </div>
            <div class="mb-3">
                ...
                <select class="form-control js-search" aria-label="Default select example" name="kategori[]" multiple style="width: 100%;">
                    <?php
                        ...
                        $isMatching = array_diff($setArr, $menu->kategori);
                    ?>
                    @foreach ($menu->kategori as $item)
                        <?php
                            if ($item == "0") {
                                $getName = "Makanan";
                            } else if ($item == "1") {
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="basic-default-company" name="harga" value="{{ $menu->harga }}" />
            </div>
            ...
            <div class="mb-3">
              <label class="form-label">Anda telah menggunakan gambar dengan nama gambar: <span class="text-danger">{{ $menu->gambar }}</span></label>
            </div>
