...
>
  <head>
    ...
    <title>Admin - PekPok Coffee</title>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
              <img src="{{ asset('assets/img/pekpok/pekpok.png') }}" alt class="w-px-40 h-auto rounded-circle" />
              <span class="app-brand-text demo menu-text fw-bolder ms-2">PekPok</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item {{ Route::is('admin.promo') ? 'active' : '' }}">
              <a href="{{ route('admin.promo') }}" class="menu-link">
            ...
            <li class="menu-item {{ Route::is('admin.testimonial') ? 'active' : '' }}">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="{{ asset('assets/img/avatars/' . Auth::user()->gambar) }}" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
